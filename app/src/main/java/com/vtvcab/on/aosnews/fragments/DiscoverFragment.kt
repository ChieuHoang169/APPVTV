...
class DiscoverFragment : BaseFragment(), ViewTreeObserver.OnScrollChangedListener {
    override fun onScrollChanged() {
        swipeRefreshContainer.isEnabled = webHome.scrollY == 0
    }

    override fun setLayoutId(): Int = R.layout.fragment_discover
    ...
    override fun bindData() {
        ...
        NewsApplication.getApiService().getUrl("discovery.html").enqueue(object : Callback<String> {
    ...
    private fun goToDetail(url: String) {
        ...
        pushFragment(R.id.homeContainerKP, DetailFragment(), bundle, true)
    }
